...
function deleteTask(id){
    ...
    let elementToRemoveChildrens = elementToRemove.children;

    elementToRemove.classList.add("disappear")
    setTimeout(()=>(elementToRemove.classList.add("reduce")),1000)
    
    for (let i = 0; i < elementToRemoveChildrens.length; i++) {
      caja.classList.add('reduce');
      elementToRemoveChildrens[i].classList.add('reduce');
      console.log(elementToRemoveChildrens[i])
    }
